                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.end,
                                        children: <Widget>[
                                          Text(snapshot.data.documents[index]['date'].toString(),textAlign: TextAlign.right,
                                            style: TextStyle(
                                              fontSize: 16,
                                              fontFamily: 'AmiriQuran',
                                              height: 1,
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.end,
                                        children: <Widget>[
                                          Text(snapshot.data.documents[index]['Ad_id'].toString(),textAlign: TextAlign.right,
                                            style: TextStyle(
                                              fontSize: 16,
                                              fontFamily: 'AmiriQuran',
                                              height: 1,
                                      ...
                                      Center(
                                        child: InkWell(
                                            onTap: (){
                                              Firestore.instance
                                                  .collection('messages').document(snapshot
                                                  .data
                                                  .documents[
                                              index]
                                                  .documentID)
                    ...
                    Positioned(
                      ...
                      child: InkWell(
                        onTap: () {
                          showSearch(
                              context: context,
                              delegate: SerchCommentsAdmin(collection: 'messages'));
                        },
                        child: Container(
                          height: 42,
                          width: 220,
